 ...
 * @constructor
 */
const WGS84LatLng = function(lat, lng) {
  this.lat = lat;
  this.lng = lng;
};
 ...
 * @constructor
 */
const GBLatLng = function(lat, lng) {
  this.lat = lat;
  this.lng = lng;
};
 ...
 * @returns {WGS84LatLng}
 */
GBLatLng.prototype.to_WGS84 = function () {
	...
	return new WGS84LatLng(rad2deg$1 * phiN, rad2deg$1 * (Math.atan(yB / xB)));
};
 ...
 * @returns {OSRef}
 */
GBLatLng.prototype.to_os_coords = function() {
 ...
 * @returns {GBLatLng}
 */
GBLatLng.from_wgs84 = function (wgs84LatLng) {
	
    //first off convert to radians
    var radWGlat = wgs84LatLng.lat * deg2rad;
    var radWGlon = wgs84LatLng.lng * deg2rad;
    ...
    return new GBLatLng(newLat * rad2deg$1, newLon * rad2deg$1);
};
 ...
 * @returns {OSCIRef}
 */
const OSCIRef = function(easting, northing) {
  this.x = easting;
  this.y = northing;
};
...
OSCIRef.prototype.to_latLng = function() {
	...
	return new WGS84LatLng(latLngRadians.lat * rad2deg$1, latLngRadians.lng * rad2deg$1);
};
 ...
 * @returns {?string}
 */
OSCIRef.prototype.to_hectad = function() {
	if (this.y > 5500000) {
 ...
 * @param {number} lng
 */
const CILatLng = function(lat, lng) {
  this.lat = lat;
  this.lng = lng;
};
 ...
 * @returns {CILatLng}
 */
CILatLng.from_wgs84 = function (wgs84LatLng) {
	var phip = wgs84LatLng.lat * deg2rad;
	var lambdap = wgs84LatLng.lng * deg2rad;
 ...
 * @returns {OSIRef}
 */
const OSIRef = function(easting, northing) {
  this.x = easting;
  this.y = northing;
};
...
OSIRef.prototype.to_latLng = function() {
	...
	Long = LongOrigin + Long * rad2deg$1;
...
OSIRef.prototype.to_gridref = function(precision) {
	...
	if (OSIRef.irishGrid[hundredkmE] && OSIRef.irishGrid[hundredkmE][hundredkmN]) {
		...
		return _e_n_to_gr(OSIRef.irishGrid[hundredkmE][hundredkmN], 
 ...
 */
OSIRef.prototype.to_hectad = function() {
 ...
 * @constructor
 */
const IELatLng = function(lat, lng) {
  this.lat = lat;
  this.lng = lng;
};
...
*/
IELatLng.prototype.to_WGS84 = function() {
 ...
 * @returns {IELatLng}
 */
IELatLng.from_wgs84 = function (wgs84LatLng) {
	...
	return new IELatLng(latlng.lat * rad2deg$1, latlng.lng * rad2deg$1);
};
 ...
 */
const NationalGridCoords = function () {};
 ...
 * @type {string}
 */
NationalGridCoords.tetradLetters = 'ABCDEFGHIJKLMNPQRSTUVWXYZ';
 ...
 * @type {string}
 */
NationalGridCoords.tetradLettersRowFirst = 'AFKQVBGLRWCHMSXDINTYEJPUZ';
 ...
 * @returns {NationalGridCoords}
 */
NationalGridCoords.from_latlng = function(lat, lng) {
	// test if GB
	if (lng >= -8.74 && lat > 49.88) {
		// lng extreme must accomodate St Kilda
		
		var os = new GBLatLng.from_wgs84(new WGS84LatLng(lat, lng)).to_os_coords();
	...
	if (lng < -5.3 && lat > 51.34 && lng > -11 && lat < 55.73) {
		var osI = new IELatLng.from_wgs84(new WGS84LatLng(lat, lng)).to_os_coords();
		...
		var osCi = new CILatLng.from_wgs84(new WGS84LatLng(lat, lng)).to_os_coords();
 ...
 */
NationalGridCoords.calculate_tetrad = function(easting, northing) {
 ...
 * @returns {OSRef}
 */
const OSRef = function(easting, northing) {
  this.x = easting;
  this.y = northing;
};
...
OSRef.gbHectads = '';
 ...
 * @return {string} hectad
 */
OSRef.prototype.to_hectad = function() {
...
OSRef.prototype.to_latLng = function() {
	...
	return (new GBLatLng(rad2deg$1 * phi, rad2deg$1 * lambda)).to_WGS84();
};
